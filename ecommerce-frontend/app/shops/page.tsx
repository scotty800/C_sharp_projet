  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        {/* En-tête */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4">Toutes les boutiques</h1>
                ...
                >
                  ...
                  <div className="px-4 pb-4">
                    <div className="flex items-end -mt-8 mb-3">
                      <div className="relative w-16 h-16 rounded-lg overflow-hidden border-4 border-white bg-white shadow-lg">
                        {shop.logoUrl ? (
                          <Image
