      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          <div className="bg-white rounded-lg shadow-lg p-12">
            ...
            <h2 className="text-2xl font-bold mb-4">Vous n'avez pas de boutique</h2>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="flex gap-2 mb-8">
          ...
          <div className={`flex-1 h-2 rounded-full ${step === 'images' ? 'bg-primary' : 'bg-gray-200'}`} />
        </div>

        {step === 'form' ? (
          <form onSubmit={handleSubmitProduct} className="bg-white rounded-lg shadow-lg p-6 space-y-6">
            <div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
            <div>
              <h2 className="text-lg font-semibold mb-4">Ajouter des images (optionnel)</h2>
