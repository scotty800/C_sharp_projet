    ...
    <footer className="bg-secondary text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Boutiques */}
          <div>
            <h4 className="text-lg font-semibold mb-4">Boutiques</h4>
            <ul className="space-y-2">
              <li>
                <Link href="/shops" className="text-gray-400 hover:text-primary transition-colors">
                  Toutes les boutiques
                </Link>
              </li>
              <li>
                <Link href="/shop/create" className="text-gray-400 hover:text-primary transition-colors">
                  Ouvrir ma boutique
                </Link>
              </li>
              <li>
